  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
     ...
     <div className='w-full'>
      ...
      <textarea onChange={(e)=>setdescripition(e.target.value)} value={descripition} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Product Discription' required/>
     </div>
     ...
     <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
      ...
      <div>
            ...
            <select onChange={(e)=>setSubCategory(e.target.value)}  className='w-full px-3 py-2'>
              ...
              <option value="Windterwear">Winterwear</option>
            </select>
      </div>
